...
intro_panel <-  tabPanel(
  ...
  p(
    a(herf = "https://www.nytimes.com/interactive/2017/08/07/opinion/leonhardt-income-inequality.html","(source)")
  ),
  ...
  # text.
  p("The diagram shows", strong("income growth"), "of the", em("poor, middle, and very affluent people"))
) 
